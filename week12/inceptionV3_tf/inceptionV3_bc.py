...
from keras.layers import GlobalAveragePooling2D,GlobalAvgPool2D
...
def InceptionV3(input_shape=[299, 299, 3],
    ...
    # Block2 17x17
    #Block2 part1
    # 35 x 25 x 288 -> 17 x 17 x 768
    branch3x3 = conv2d_bn(x, 384, 3, 3, strides=(2, 2), padding='valid')

    branch3x3db1 = conv2d_bn(x, 64, 1, 1)
    branch3x3db1 = conv2d_bn(branch3x3db1, 96, 3, 3)
    branch3x3db1 = conv2d_bn(
        branch3x3db1, 96, 3, 3, strides=(2, 2), padding='valid')
    ...
    # 17 x 17 x 768 -> 17 x17 x 768 -> 17 x 17 x 768
    for i in range(2):
        branch1x1 = conv2d_bn(x, 192, 1, 1)
    ...
    for i in range(2):
        ...
        branch3x3db1 = layers.concatenate(
            [branch3x3db1_1, branch3x3db1_2], axis=3)
